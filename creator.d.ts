...
declare module cc {
    ...
    export let js: any;
    export let _RFpeek: ()=>any;
    export let GLProgram: any;
    export let GLProgramState: any;
    export class _Class {
    }
    namespace _ccsg {
        type Sprite = any;
    ...
    /** !#en
     ...
     ```
     */
    export function sequence(...tempArray: Array<Action>): ActionInterval;

    export function callFunc(func: ()=>void): ActionInstant;
    ...
    /** !#en Create a spawn action which runs several actions in parallel.
     ...
     ```
     */
    export function spawn(...tempArray: Array<Action>): FiniteTimeAction;
...
// export function Class<T, S extends T & P, P>(options: {extends: T, properties: P} & S): T & S & P;
    ...
    export class Node extends _BaseNode {
        ...
        /** !#en Adds a component class to the node. You can also add component to node by passing in the name of the script.
         ...
         ```
         */
        addComponent<T>(typeOrClassName: (new()=>T)): T;
        addComponent(typeOrClassName: string): any;
        ...
        /** !#en
         ...
         ```
         */
        on(type: string|number, callback: (param: Event) => void, target?: any, useCapture?: boolean): Function;

        once(type: string|number, callback: (param: Event) => void, target?: any, useCapture?: boolean): Function;
        ...
        /** !#en
         ...
         ```
         */
        off(type: string|number, callback: Function, target?: any, useCapture?: boolean): void;
    ...
    export class Component extends Object {
        ...
        /** !#en Adds a component class to the node. You can also add component to node by passing in the name of the script.
         ...
         ```
         */
        addComponent<T>(typeOrTypename: (new()=>T)): T;
        addComponent(typeOrTypename: string): any;
        ...
        /** !#en Returns all components of supplied Type in the node.
         ...
         ```
         */
        getComponents<T>(typeOrClassName: (new()=>T)): Array<T>;
        getComponents(typeOrClassName: string): Array<any>;
        ...
        /** !#en Returns the component of supplied type in any of its children using depth first search.
         ...
         ```
         */
        getComponentInChildren<T>(typeOrClassName: (new()=>T)): T;
        getComponentInChildren(typeOrClassName: string): any;
        ...
        /** !#en Returns the components of supplied type in self or any of its children using depth first search.
         ...
         ```
         */
        getComponentsInChildren<T>(typeOrClassName: (new()=>T)): Array<T>;
        getComponentsInChildren(typeOrClassName: string): Array<any>;
    ...
    export let eventManager: IeventManager;
    ...
    export class ILoader extends Pipeline {
        abc: any;
        ...
        /** Load resources with a progression callback and a complete callback.
         ...
         ```
         */
        load(resources: string|any[]|{id:string, type:string}, progressCallback?: Function, completeCallback?: Function): void;
    ...
    export class ValueType {
        ...
        /** !#en
         ...
         @param ratio the interpolation coefficient
         */
        lerp(to: any, ratio: number, out?: any): any;
    }
    ...
    export module Component {
        export let _addMenuItem: any;
        export function _registerEditorProps(cls: any, currentEditor: any):void;
        /** !#en
    ...
    interface IProps<T> {
        [index: string]: IProp | T;
    }

    export function Class<Base, Func, Props, This extends Base>(options: {
        name?;
        extends?: (new ()=>Base);
        ctor?;
        properties?: Props;
        ...
        onRestore?;
        _getLocalBounds?;
    } & Func): (new()=> Func &  Props & This) & Func & Props & This;
    export module Class {
        export let _isCCClass: any;
        export let Attr: any;
        export let attr: any;
    }
}
